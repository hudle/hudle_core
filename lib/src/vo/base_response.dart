...
import 'package:hudle_core/src/network/dio_network.dart';
...
class BaseResponse<Data> {
  ...
  BaseResponse.fromError(String errorMessage, {int errorCode = ErrorCode.UNKNOWN_ERROR, ValidationError? error}) {
    success = false;
